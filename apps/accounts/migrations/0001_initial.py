    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('daily_goal', models.IntegerField(default=20, verbose_name='일일 학습 목표 단어 수')),
                ('level', models.IntegerField(default=1, verbose_name='레벨')),
                ('experience', models.IntegerField(default=0, verbose_name='경험치')),
                ('total_studied_words', models.IntegerField(default=0, verbose_name='총 학습 단어 수')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='가입일')),
                ('last_login_at', models.DateTimeField(auto_now=True, verbose_name='최근 로그인')),
